...
public class UidInfo {
    ...
    public UidInfo(UidInfoDto source) {
        ...
        this.m_uidVersion = source.m_uidVersion;
    ...
    public UidInfoDto toDto() {
        ...
        ret.m_uidVersion = this.m_uidVersion;
    ...
    public void setVersion(String version) {
        this.m_uidVersion = version;
    }

    /**
     * @return the uid version
     */
