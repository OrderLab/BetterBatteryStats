 ...
 * @author sven
 */
public class WakelockStat extends StatElement implements Comparable<WakelockStat>, Serializable {
    /**
     * the tag for logging
     */
    private static transient final String TAG = "WakelockStat";
    ...
    public WakelockStat(int wakeType, String name, long duration, long time, int count) {
        m_wakeType = wakeType;
    ...
    public WakelockStat(WakelockDto source) {
    ...
    public WakelockStat clone() {
        WakelockStat clone = new WakelockStat(m_wakeType, m_name, m_duration, getTotal(), m_count);
    ...
    public void substractFromRef(List<StatElement> myList) {
        if (myList != null) {
            for (int i = 0; i < myList.size(); i++) {
                try {
                    WakelockStat myRef = (WakelockStat) myList.get(i);
    ...
    public String toString() {
        return "WakelockStat [m_wakeType=" + m_wakeType + ", m_name=" + m_name
     ...
     */
    public int compareTo(WakelockStat o) {
    ...
    public static class WakelockCountComparator implements Comparator<WakelockStat> {
        public int compare(WakelockStat a, WakelockStat b) {
            return ((int) (b.getCount() - a.getCount()));
        }
    }

    public static class WakelockTimeComparator implements Comparator<WakelockStat> {
        public int compare(WakelockStat a, WakelockStat b) {
