...
public class BatteryStatsProxy {
    ...
    @SuppressWarnings("rawtypes")
    private Class m_BatteryStatsImplCls = null;
    @SuppressWarnings("rawtypes")
    private Class m_BatteryStatsUidCls = null;
    @SuppressWarnings("rawtypes")
    private Class m_BatteryStatsUidProcCls = null;

    private Method m_GetUidMethod = null;
    private Method m_GetWakelockStatsMethod = null;
    private Method m_GetWakeTimeMethod = null;
    private Method m_GetWakeTotalTimeLockedMethod = null;
    private Method m_GetWakeCountLockedMethod = null;
    private Method m_GetPackageStatsMethod = null;
    private Method m_GetProcessStatsMethod = null;
    private Method m_GetWakeUpsMethod = null;
    private Method m_GetWakeupAlarmStatsMethod = null;
    private Method m_GetWakeAlarmCountMethod = null;
    private Method m_GetTcpBytesReceivedMethod = null;
    private Method m_GetTcpBytesSentMethod = null;
    private Method m_GetNetworkActivityCountMethod = null;
    private Method m_GetNetworkActivityBytesMethod = null;
    ...
    private void CommonReflections(ClassLoader cl) throws Exception {

        m_BatteryStatsImplCls = cl.loadClass("com.android.internal.os.BatteryStatsImpl");
        m_BatteryStatsUidCls = cl.loadClass("com.android.internal.os.BatteryStatsImpl$Uid");
        m_BatteryStatsUidProcCls = cl.loadClass("com.android.internal.os.BatteryStatsImpl$Uid$Proc");

        m_GetUidMethod = m_BatteryStatsUidCls.getMethod("getUid");
        m_GetProcessStatsMethod = m_BatteryStatsUidCls.getMethod("getProcessStats");
        m_GetWakelockStatsMethod = m_BatteryStatsUidCls.getMethod("getWakelockStats");
        m_GetPackageStatsMethod = m_BatteryStatsUidCls.getMethod("getPackageStats");

        @SuppressWarnings("rawtypes")
        Class batteryStatsUidWakelock = cl.loadClass("com.android.internal.os.BatteryStatsImpl$Uid$WakelockStat");
        //Parameters Types
        @SuppressWarnings("rawtypes")
        Class[] paramTypesGetWakeTime = new Class[1];
        paramTypesGetWakeTime[0] = int.class;
        m_GetWakeTimeMethod = batteryStatsUidWakelock.getMethod("getWakeTime", paramTypesGetWakeTime);

        @SuppressWarnings("rawtypes")
        Class iBatteryStatsTimer = cl.loadClass("com.android.internal.os.BatteryStatsImpl$Timer");
        //Parameters Types
        @SuppressWarnings("rawtypes")
        Class[] paramTypesGetTotalTimeLocked = new Class[]{long.class, int.class};
        m_GetWakeTotalTimeLockedMethod = iBatteryStatsTimer.getMethod("getTotalTimeLocked",
        ...
        m_GetWakeCountLockedMethod = iBatteryStatsTimer.getMethod("getCountLocked", paramTypesGetCountLocked);
        ...
        if (android.os.Build.VERSION.SDK_INT <= android.os.Build.VERSION_CODES.LOLLIPOP_MR1) {
            ...
            m_GetWakeUpsMethod = batteryStatsUidPkg.getMethod("getWakeups", paramTypesGetWakeups);
        } else {
            @SuppressWarnings("rawtypes")
            Method m_GetWakeAlarmStatsMethod = batteryStatsUidPkg.getMethod("getWakeupAlarmStats");
            ...
            m_GetWakeAlarmCountMethod = batteryStatsCounter.getMethod("getCountLocked", paramsTypesGetCountLocked);
        }
        ...
        if (Build.VERSION.SDK_INT < 19) {
            ...
            m_GetTcpBytesReceivedMethod = m_BatteryStatsUidCls.getMethod("getTcpBytesReceived", paramTypesGetTcpBytesXxx);
            m_GetTcpBytesSentMethod = m_BatteryStatsUidCls.getMethod("getTcpBytesSent", paramTypesGetTcpBytesXxx);
        } else if (Build.VERSION.SDK_INT <= 21) {
            Class[] paramTypesGetNetworkActivity = new Class[]{int.class, int.class};
            m_GetNetworkActivityCountMethod = m_BatteryStatsUidCls.getMethod("getNetworkActivityCount",
                    paramTypesGetNetworkActivity);
        } else {
            Class[] paramTypesGetNetworkActivity = new Class[]{int.class, int.class};
            m_GetNetworkActivityBytesMethod = m_BatteryStatsUidCls.getMethod("getNetworkActivityBytes",
                    paramTypesGetNetworkActivity);
        }
            ...
            try {
                ...
                for (int iu = 0; iu < NU; iu++) {
                    ...
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                        ...
                        if (sensorStats.size() > 0) {
                            // Map of String, BatteryStats.Uid.WakelockStat
    ...
    public ArrayList<StatElement> getAllAppStats(Context context, int iWakeType, int iStatType, int iWlPctRef) throws Exception {
        ...
        if (m_uidStats != null) {
            try {
                ...
                for (int iu = 0; iu < NU; iu++) {
                    // Object is an instance of BatteryStats.Uid
                    Object myUid = m_uidStats.valueAt(iu);
                    Integer uid = (Integer) m_GetUidMethod.invoke(myUid);
                    UidInfo myInfo = UidNameResolver.getInstance(context).getNameForUid(uid);
                    ArrayList<StatElement> stats = getProcessStatsForUid(uid, myUid, iStatType);
                    for (StatElement stat : stats) {
                        stat.setUidInfo(myInfo);
                        myStats.add(stat);
                    }
                    stats = getWakelockStatsForUid(uid, myUid, context, iWakeType,
                            iStatType, iWlPctRef, uSecBatteryTime, uSecAwakeTime, uSecScreenOnTime);
                    for (StatElement stat : stats) {
                        stat.setUidInfo(myInfo);
                        myStats.add(stat);
                    }

                    stats = getWakeupStatsForUid(uid, myUid, context, iStatType);
                    ...
                    stats = getNetworkUsageStatsForUid(uid, myUid, context, iStatType);
                    for (StatElement stat : stats) {
                        stat.setUidInfo(myInfo);
                        myStats.add(stat);
                    }
                ...
                Log.e(TAG, "An exception occured in getAllAppStats(). Message: " + e.getMessage() +
    ...
    public ArrayList<StatElement> getWakelockStatsForUid(int uid, Object myUid, Context context,
                                                         int iWakeType, int iStatType, int iWlPctRef, long uSecBatteryTime, long uSecAwakeTime, long uSecScreenOnTime) throws Exception {
        ArrayList<StatElement> myStats = new ArrayList<StatElement>();

        // Map of String, BatteryStats.Uid.WakelockStat
        Map<String, ? extends Object> wakelockStats = (Map<String, ? extends Object>) m_GetWakelockStatsMethod.invoke(myUid);
        ...
        for (Map.Entry<String, ? extends Object> wakelockEntry : wakelockStats.entrySet()) {
            ...
            // BatteryStats.Timer
            Object wakeTimer = m_GetWakeTimeMethod.invoke(wakelock, paramsGetWakeTime);
            if (wakeTimer != null) {
                //Parameters
                ...
                Long wake = (Long) m_GetWakeTotalTimeLockedMethod.invoke(wakeTimer, paramsGetTotalTimeLocked);
//				Log.d(TAG, "Wakelocks inner: ProcessStat = " + wakelockEntry.getKey() + " wakelock [s] " + wake);
                wakelockTime += wake;
                ...
                Integer count = (Integer) m_GetWakeCountLockedMethod.invoke(wakeTimer, paramsGetCountLocked);
//				Log.d(TAG, "Wakelocks inner: ProcessStat = " + wakelockEntry.getKey() + " count " + count);
                wakelockCount += count;
            }
//			else
//			{
//				Log.d(TAG, "Wakelocks: ProcessStat = " + wakelockEntry.getKey() + " with no Timer spotted");
//			}
            ...
            WakelockStat myWl = null;
            if (Build.VERSION.SDK_INT >= 20) {
                myWl = new WakelockStat(iWakeType, wakelockEntry.getKey(), wakelockTime, uSec, wakelockCount);

            } else {
                myWl = new WakelockStat(iWakeType, wakelockEntry.getKey(), wakelockTime, uSec / 1000, wakelockCount);
            }
...
//			Log.d(TAG, "Wakelocks: ProcessStat = " + wakelockEntry.getKey() + " wakelock [s] " + wakelockTime + ", count " + wakelockCount);
        }
        return myStats;
    }

    /**
     * Obtain the wakelock stats as a list of Wakelocks (@see edu.jhu.order.appstatstracker.batterystats.WakelockStat}
     *
     * @param context   a Context
     * @param iWakeType a type of wakelock @see edu.jhu.order.appstatstracker.batterystats.BatteryStatsTypes
     * @param iStatType a type of stat @see edu.jhu.order.appstatstracker.batterystats.BatteryStatsTypes
     * @return a List of WakelockStat s
     * @throws Exception
     */
    @SuppressWarnings("unchecked")
        ...
        if (m_uidStats != null) {
            ...
            try {
                ...
                for (int iu = 0; iu < NU; iu++) {
                    ...
                    Object myUid = m_uidStats.valueAt(iu);
                    Integer uid = (Integer) m_GetUidMethod.invoke(myUid);
                    ArrayList<StatElement> stats = getWakelockStatsForUid(uid, myUid, context, iWakeType,
                            iStatType, iWlPctRef, uSecBatteryTime, uSecAwakeTime, uSecScreenOnTime);
                    myStats.addAll(stats);
                }
            } catch (Exception e) {
...
//				}	
    ...
    public ArrayList<StatElement> getProcessStatsForUid(int uid, Object myUid, int iStatType) throws Exception {

        ArrayList<StatElement> myStats = new ArrayList<StatElement>();

        // Map of String, BatteryStats.Uid.Proc
        Map<String, ? extends Object> processStats = (Map<String, ? extends Object>) m_GetProcessStatsMethod.invoke(myUid);

        if (processStats.size() > 0) {
            for (Map.Entry<String, ? extends Object> ent : processStats.entrySet()) {
                if (CommonLogSettings.TRACE) {
                    Log.d(TAG, "ProcessStat name = " + ent.getKey());
                }
                // Object is a BatteryStatsTypes.Uid.Proc
                ...
                Method methodGetUserTime = m_BatteryStatsUidProcCls.getMethod("getUserTime", paramTypesGetXxxTime);
                Method methodGetSystemTime = m_BatteryStatsUidProcCls.getMethod("getSystemTime", paramTypesGetXxxTime);
                Method methodGetStarts = m_BatteryStatsUidProcCls.getMethod("getStarts", paramTypesGetXxxTime);
                ...
                if ((userTime + systemTime) > 100) {
                    ProcessStat myPs = new ProcessStat(ent.getKey(), userTime, systemTime, starts);
                    // opt for lazy loading: do no populate UidInfo, just uid. UidInfo will be fetched on demand
                    myPs.setUid(uid);
                    // try resolving names
//								String myName = m_nameResolver.getLabel(context, ent.getKey());
                    ...
                    if (CommonLogSettings.TRACE) {
                        Log.d(TAG, "ProcessStat " + ent.getKey() + " was discarded (CPU time =0)");
                    }
                }
            }
        }
    ...
    /**
     * Obtain the process stats as a list of Processes (@see edu.jhu.order.appstatstracker.batterystats.ProcessStat}
     *
     * @param context   a Context
     * @param iStatType a type of stat @see edu.jhu.order.appstatstracker.batterystats.BatteryStatsTypes
     * @return a List of ProcessStat es
     * @throws Exception
     */
    @SuppressWarnings("unchecked")
    ...
    /**
     * Obtain the wakeup stats as a list of Alarms (@see edu.jhu.order.appstatstracker.batterystats.AlarmStat}
     *
     * @param context   a Context
     * @param iStatType a type of stat @see edu.jhu.order.appstatstracker.batterystats.BatteryStatsTypes
     * @return a List of ProcessStat es
    ...
    @SuppressWarnings("unchecked")
    public ArrayList<StatElement> getWakeupStatsForUid(int uid, Object myUid, Context context, int iStatType) throws Exception {
        if (android.os.Build.VERSION.SDK_INT <= android.os.Build.VERSION_CODES.LOLLIPOP_MR1) {
            return getWakeupStatsPre6ForUid(uid, myUid, context, iStatType);
        } else {
            return getWakeupStatsPost6ForUid(uid, myUid, context, iStatType);
        }
    }

    @SuppressWarnings("unchecked")
    public ArrayList<StatElement> getWakeupStatsPre6ForUid(int uid, Object myUid, Context context, int iStatType) throws Exception {
        ArrayList<StatElement> myStats = new ArrayList<StatElement>();

        // Map of String, BatteryStats.Uid.Proc
        Map<String, ? extends Object> packageStats = (Map<String, ? extends Object>) m_GetPackageStatsMethod.invoke(myUid);
        ...
        if (packageStats.size() > 0) {
            for (Map.Entry<String, ? extends Object> ent : packageStats.entrySet()) {
                ...
                int wakeups = (Integer) m_GetWakeUpsMethod.invoke(ps, paramsGetWakeups);
                ...
                if ((wakeups) > 0) {
                    AlarmStat myWakeup = new AlarmStat(ent.getKey(), "*api*");
...
//								String myName = m_nameResolver.getLabel(context, ent.getKey());
        ...
        if (m_uidStats != null) {
            try {
                ...
                for (int iu = 0; iu < NU; iu++) {
                    ...
                    Object myUid = m_uidStats.valueAt(iu);
                    Integer uid = (Integer) m_GetUidMethod.invoke(myUid);
                    ArrayList<StatElement> stats = getWakeupStatsPre6ForUid(uid, myUid, context, iStatType);
                    myStats.addAll(stats);
                }
            } catch (Exception e) {
    ...
    @SuppressLint("NewApi")
    @SuppressWarnings("unchecked")
    public ArrayList<StatElement> getWakeupStatsPost6ForUid(int uid, Object myUid, Context context, int iStatType) throws Exception {
        ArrayList<StatElement> myStats = new ArrayList<StatElement>();
        // Map of String, BatteryStats.Uid.Proc
        Map<String, ? extends Object> packageStats = (Map<String, ? extends Object>) m_GetPackageStatsMethod.invoke(myUid);
        ...
        if (packageStats.size() > 0) {
            for (Map.Entry<String, ? extends Object> ent : packageStats.entrySet()) {
                ...
                Map<String, ? extends Object> wakeupStats =
                        (Map<String, ? extends Object>) m_GetWakeupAlarmStatsMethod.invoke(ps);
                ...
                for (Map.Entry<String, ? extends Object> wa : wakeupStats.entrySet()) {
                    ...
                    int wakeups = (Integer) m_GetWakeAlarmCountMethod.invoke(counter, paramsGetCountLocked);
        ...
        if (m_uidStats != null) {
            try {
                ...
                for (int iu = 0; iu < NU; iu++) {
                    ...
                    Object myUid = m_uidStats.valueAt(iu);
                    Integer uid = (Integer) m_GetUidMethod.invoke(myUid);
                    ArrayList<StatElement> stats = getWakeupStatsPost6ForUid(uid, myUid, context, iStatType);
                    myStats.addAll(stats);
                }
            } catch (Exception e) {
                Log.e(TAG, "An exception occured in getWakeupStats(). Message: " + e.getMessage() + ", cause: " + e.getCause().getMessage());
    ...
    public ArrayList<StatElement> getNetworkUsageStatsForUid(int uid, Object myUid, Context context, int iStatType) throws Exception {
        ArrayList<StatElement> myStats = new ArrayList<StatElement>();
        ...
        if (Build.VERSION.SDK_INT < 19) {
            ...
            bytesReceived = (Long) m_GetTcpBytesReceivedMethod.invoke(myUid, paramGetTcpBytesXxx);
            bytesSent = (Long) m_GetTcpBytesSentMethod.invoke(myUid, paramGetTcpBytesXxx);
        } else if (Build.VERSION.SDK_INT <= 21) {
            // Parameters for getting received bytes from mobile
            Object paramGetNetworkActivityCount[] = {NETWORK_MOBILE_RX_BYTES,
                    iStatType};
            bytesReceivedMobile = (Long) m_GetNetworkActivityCountMethod.invoke(myUid, paramGetNetworkActivityCount);
            // change parameter to get received bytes from wifi
            paramGetNetworkActivityCount[0] = NETWORK_WIFI_RX_BYTES;
            // add together for now
            bytesReceivedWifi = (Long) m_GetNetworkActivityCountMethod.invoke(myUid, paramGetNetworkActivityCount);

            // same for transmitted bytes
            paramGetNetworkActivityCount[0] = NETWORK_MOBILE_TX_BYTES;
            bytesSentMobile = (Long) m_GetNetworkActivityCountMethod.invoke(myUid, paramGetNetworkActivityCount);
            paramGetNetworkActivityCount[0] = NETWORK_WIFI_TX_BYTES;
            bytesSentWifi = (Long) m_GetNetworkActivityCountMethod.invoke(myUid, paramGetNetworkActivityCount);
        } else {
            // Parameters for getting received bytes from mobile
            Object paramGetNetworkActivityCount[] = {NETWORK_MOBILE_RX_BYTES,
                    iStatType};
            bytesReceivedMobile = (Long) m_GetNetworkActivityBytesMethod.invoke(myUid, paramGetNetworkActivityCount);
            // change parameter to get received bytes from wifi
            paramGetNetworkActivityCount[0] = NETWORK_WIFI_RX_BYTES;
            // add together for now
            bytesReceivedWifi = (Long) m_GetNetworkActivityBytesMethod.invoke(myUid, paramGetNetworkActivityCount);

            // same for transmitted bytes
            paramGetNetworkActivityCount[0] = NETWORK_MOBILE_TX_BYTES;
            bytesSentMobile = (Long) m_GetNetworkActivityBytesMethod.invoke(myUid, paramGetNetworkActivityCount);
            paramGetNetworkActivityCount[0] = NETWORK_WIFI_TX_BYTES;
            bytesSentWifi = (Long) m_GetNetworkActivityBytesMethod.invoke(myUid, paramGetNetworkActivityCount);
        }
    ...
    /**
     * Obtain the network usage stats as a list of NetworkUsages (@see edu.jhu.order.appstatstracker.batterystats.NetworkUsage}
     *
     * @param context   a Context
     * @param iStatType a type of stat @see edu.jhu.order.appstatstracker.batterystats.BatteryStatsTypes
        ...
        if (m_uidStats != null) {
            try {
                ...
                for (int iu = 0; iu < NU; iu++) {
                    ...
                    Object myUid = m_uidStats.valueAt(iu);
                    Integer uid = (Integer) m_GetUidMethod.invoke(myUid);
                    ArrayList<StatElement> stats = getNetworkUsageStatsForUid(uid, myUid, context, iStatType);
                    myStats.addAll(stats);
                }
            } catch (Exception e) {
                throw e;
